      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center bg-slate-900 rounded-2xl px-4 py-2 w-80 group focus-within:ring-2 focus-within:ring-primary/50 transition-all border border-slate-800">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-slate-800 animate-pulse overflow-hidden ring-2 ring-primary/10 group-hover:ring-primary/30 transition-all">
                {profile?.photoURL ? (
                  <img
