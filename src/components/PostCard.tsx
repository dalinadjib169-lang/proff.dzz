    ...
    <div className={cn(
      ...
      <div className="px-4 py-3">
        {isEditingPost ? (
          ...
          <div className="p-8 rounded-2xl flex items-center justify-center text-center text-lg sm:text-xl font-black text-white min-h-[160px] shadow-inner" style={{ backgroundImage: post.background, backgroundSize: 'cover', backgroundPosition: 'center' }}>
